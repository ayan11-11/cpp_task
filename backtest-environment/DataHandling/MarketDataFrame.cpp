...
MarketDataFrame::MarketDataFrame(char csv_file[FILENAME_MAX], string symbol) {
    ...
    map<long, double> low;
    map<long, double> close;
    map<long, double> trades;
    map<long, double> volume;
    map<long, double> vwap;
    map<long, double> lastSize;
    map<long, double> turnover;
    map<long, double> homeNotional;
    map<long, double> foreignNotional;
    ...
    while(getline(csv, line)) {
        ...
        ss >> volume[epochdate];
        ss >> vwap[epochdate];
        ss >> lastSize[epochdate];
        ss >> turnover[epochdate];
        ss >> homeNotional[epochdate];
        ss >> foreignNotional[epochdate];
    ...
    // data["homeNotional"] = homeNotional;
    // data["foreignNotional"] = foreignNotional;
