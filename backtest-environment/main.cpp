...
int main(int argc, char **argv) {
    ...
    auto startdate = string("2018-01-01");
    auto enddate = string("2020-08-19");
    double initialcapital = 100000000;
    int showholdings = 0;
    vector<string> symbol_list = {string("XBTUSD")};
    vector<string> symbol_list2 = {string("XBTUSD")};

    TradingInterface interface = TradingInterface(&symbol_list, {string("XBTUSD")}, &initialcapital, &startdate, &enddate);
